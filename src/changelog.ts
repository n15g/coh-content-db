...
export const CHANGELOG: Change[] = [
  {
    ...
    description: ''
      ...
      + '* Package divided into two core modules: `api` - for integrators creating content packages, and `db` for integrators who want to consume those packages.\n'
      + '* Standardized pluralization of some field names (name, icon).\n'
      + '* Combined `settitle` ids into a single field.\n'
